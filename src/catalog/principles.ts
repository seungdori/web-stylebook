...
const principleEntries: UxPrinciple[] = [
  ...
  principle(
    ...
    ['decision', 'action'],
    ['navigation', 'search', 'form', 'checkout'],
  ...
  principle(
    ...
    ['content', 'form', 'data-table', 'navigation'],
  ...
  principle(
    ...
    ['global', 'form', 'onboarding', 'developer-console'],
  ...
  principle(
    ...
    ['global', 'navigation', 'form', 'checkout'],
  ...
  principle(
    ...
    ['comprehension', 'action', 'trust'],
    ['global', 'navigation', 'form', 'settings', 'developer-console'],
  ...
  principle(
    ...
    ['attention', 'comprehension'],
    ['global', 'navigation', 'data-table', 'checkout', 'developer-console'],
    ['structure', 'content', 'validation'],
  ...
  principle(
    ...
    ['attention', 'memory'],
    ['navigation', 'content', 'checkout', 'onboarding'],
    ['structure', 'content', 'validation'],
