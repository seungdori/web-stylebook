        ...
        <main className="page">
          ...
          <section className="hero">
            <div className="hero-copy">
              ...
              <p className="lead" data-lang="ko" hidden>마시멜로나 찰흙처럼 포근하고 푹신한 입체감을 살린 친근한 UI입니다. 그림자를 두 겹으로 겹쳐 요소가 둥실 떠오르면서 안에서부터 부풀어 오른 듯한 부드러운 볼륨감을 냅니다.</p>
              <p className="lead" data-lang="ja" hidden>マシュマロや粘土のように、やわらかくふっくらとした立体感のある親しみやすいUI。影を二重に重ねることで、要素がふわりと浮かびながら、内側からふくらんだようなボリューム感を生み出します。</p>
          ...
          <div className="demo">
            ...
            <div className="clay-tablet-grid">
              <article className="clay-tablet">
                ...
                <p data-lang="ko" hidden>모든 면에 넉넉한 border-radius(20~40px)를 줘서 날카로운 모서리를 완전히 없앱니다.</p>
              ...
              <article className="clay-tablet">
                ...
                <p data-lang="ko" hidden>깊이를 내는 아웃셋 그림자에 부풀어 오른 볼륨감을 더하는 인셋 그림자 — 클레이의 핵심 레시피입니다.</p>
                <p data-lang="ja" hidden>奥行きを出すアウトセットシャドウに、ふくらみを出すインセットシャドウを重ねる — クレイの基本レシピ。</p>
              </article>
              <article className="clay-tablet">
                ...
                <p data-lang="ko" hidden>은은한 상단 조명 그라데이션과 흰색 내부 그림자가 빛을 받은 점토처럼 보이게 합니다.</p>
                <p data-lang="ja" hidden>ほのかなトップライトのグラデーションと白いインナーシャドウで、光を受けた成形粘土のような質感を生み出します。</p>
              </article>
            </div>
            {/* Toggle Switches */}
            ...
            <div className="clay-progress-wrap">
              ...
              <div className="clay-progress-item">
                ...
                <span className="clay-progress-label" data-lang="ko" hidden>말랑말랑함 — 90%</span>
