        ...
        <main className="container">
          ...
          <section className="sticker-section">
            ...
            <div className="sticker-grid">
              <div className="sticker">
                ...
                <span className="sticker-text" data-lang="ko" hidden>굵은 외곽선의 대형 헤딩. 짧고 강렬한 카피. 리듬을 반복하세요.</span>
                <span className="sticker-text" data-lang="ja" hidden>太いアウトラインの大型見出し。短く力強いコピー。リズムを繰り返す。</span>
              </div>
              <div className="sticker">
                <span className="sticker-peel" />
                ...
                <span className="sticker-text" data-lang="ko" hidden>원, 삼각형, 사각형 — 각각 팝 컬러로. 모든 요소에 4-5px 두꺼운 잉크 테두리.</span>
              ...
              <div className="sticker">
                ...
                <span className="sticker-text" data-lang="ko" hidden>액션을 위한 고채도 포인트. 검정 위의 노랑. 굵은 드롭 섀도. 섬세함 불필요.</span>
          ...
          <section className="bubble-section">
            <div className="speech-bubble">
              ...
              <span data-lang="ko" hidden>채도 높은 2-3가지 색상으로 제한하세요. 팝아트는 다양성이 아닌 대비가 핵심입니다.</span>
            ...
            <div className="speech-bubble">
              ...
              <span data-lang="ko" hidden>모든 요소가 움직이는 느낌이어야 합니다 — 회전, 스케일, 오프셋 섀도가 운동 에너지를 만듭니다.</span>
