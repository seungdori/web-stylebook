            ...
            <main id="main-content">
              <section className="hero">
                <div className="hero__body">
                  ...
                  <h1 data-lang="ko" hidden>기술적인 신뢰는 구조, 절제, 그리고 한 가지 포인트 색에서 나옵니다.</h1>
                  ...
                  <p className="hero__note" data-lang="ko" hidden>
                    페이지가 장식적으로 느껴지기 시작하면, <span className="note-highlight">구조를 지우기 전에 먼저 색을 줄이세요</span>.
                  </p>
              ...
              <section className="section section--center" id="layer">
                ...
                <h2 className="display-accent" data-lang="ko" hidden>이 스타일은 세 가지 기준으로 정리됩니다.</h2>
                ...
                <p className="section__intro" data-lang="ko" hidden>
                  목표는 기술적인 장식을 더하는 것이 아닙니다. 구조, 타이포, 포인트 색 하나로 안정된 운영형 톤을 만드는 것입니다.
                </p>
                <p className="section__intro" data-lang="ja" hidden>
                  目的は技術的な装飾を増やすことではありません。構造、タイポ、差し色一つで安定した運用トーンを作ることです。
                </p>
                <div className="feature-grid">
                  <article className="feature-card">
                    ...
                    <p data-lang="ko" hidden>그리드는 정렬과 분위기를 도와야 합니다. 장식처럼 보이기 시작하면 이미 너무 시끄러운 상태입니다.</p>
                  ...
                  <article className="feature-card">
                    ...
                    <h3 data-lang="ko" hidden>권위는 헤드라인이 가져가게 둡니다.</h3>
                    ...
                    <p data-lang="ko" hidden>메인 목소리는 Instrument Sans가 맡고, 모노는 라벨과 시각 정보 같은 보조 유틸리티에만 좁게 씁니다.</p>
                    <p data-lang="ja" hidden>主役の声は Instrument Sans に 맡기、モノはラベルや時刻のような補助的ユーティリティにだけ細く使います。</p>
                  </article>
                  <article className="feature-card">
                    ...
                    <p data-lang="ko" hidden>미네랄 틸 하나면 메인 CTA와 핵심 문장 하나를 충분히 처리할 수 있습니다. 깊이는 그림자보다 간격과 보더에서 나와야 합니다.</p>
                    <p data-lang="ja" hidden>ミネラルティール一つでメインCTAと焦点文を十分に処理できます。奥行きは影ではなく、余白とボーダーから生まれるべきです。</p>
                  </article>
                </div>
              </section>
                ...
                <div className="trace-layout">
                    ...
                    <div className="trace-list">
                      <div className="trace-row">
                        ...
                        <div>
                          ...
                          <p className="trace-row__meta" data-lang="ko" hidden>유틸리티 신호는 헤드라인보다 먼저 오지만, 절대 경쟁하지 않습니다</p>
                      ...
                      <div className="trace-row">
                        ...
                        <div>
                          ...
                          <div className="trace-row__title" data-lang="ko" hidden>헤드라인은 과장 없이 여러 줄로 힘을 가집니다</div>
                          <div className="trace-row__title" data-lang="ja" hidden>見出しは大げさな演出なしで複数行の強さを持ちます</div>
                          <p className="trace-row__meta" data-lang="en">authority comes from size, weight, and line breaks</p>
                          <p className="trace-row__meta" data-lang="ko" hidden>권위는 크기, 굵기, 줄바꿈에서 나옵니다</p>
                      ...
                      <div className="trace-row">
                        ...
                        <div>
                          ...
                          <div className="trace-row__title" data-lang="ja" hidden>差し色は焦点文とアクティブ要素に一度だけ現れます</div>
                          <p className="trace-row__meta" data-lang="en">one bright decision is stronger than five small ones</p>
                          <p className="trace-row__meta" data-lang="ko" hidden>밝은 결정 하나가 작은 강조 다섯 개보다 강합니다</p>
                          <p className="trace-row__meta" data-lang="ja" hidden>明るい判断ひとつの方が、小さな強調五つより強く働きます</p>
                        </div>
                      ...
                      <div className="trace-row">
                        ...
                        <div>
                          ...
                          <div className="trace-row__title" data-lang="ko" hidden>패널은 플랫하고, 보더가 얇고, 명도 차가 작아야 합니다</div>
                          <div className="trace-row__title" data-lang="ja" hidden>パネルはフラットで、細いボーダーと近い明度差を保ちます</div>
                          <p className="trace-row__meta" data-lang="en">depth comes from layering and spacing, not from shadows</p>
                          <p className="trace-row__meta" data-lang="ko" hidden>깊이는 그림자가 아니라 레이어와 간격에서 나옵니다</p>
                  ...
                  <div className="proof-stack">
                    ...
                    <article className="quote-card">
                      ...
                      <blockquote data-lang="ko" hidden>“칩을 너무 많이 두거나, 밝은 색을 여러 개 쓰거나, 그림자를 무겁게 쓰거나, 미래주의 카피를 넣는 순간 톤이 가장 먼저 무너집니다.”</blockquote>
                      <blockquote data-lang="ja" hidden>「チップを増やしすぎること、明るい色を複数使うこと、影を重くすること、未来主義のコピーを書くことが、このトーンを最も早く壊します。」</blockquote>
                      <div className="quote-card__meta" data-lang="en">Common failure mode of this style</div>
                      <div className="quote-card__meta" data-lang="ko" hidden>이 스타일에서 가장 흔한 실패 방식</div>
              ...
              <section className="section" id="examples">
                ...
                <p className="section__intro" data-lang="ko" hidden>
                  ...
                  모두 플랫하고, 보더 한 줄로 정리되어 있으며, 조용하게 유지되기 때문에 레이아웃이 콘텐츠와 경쟁하지 않습니다.
                </p>
                <p className="section__intro" data-lang="ja" hidden>
                ...
                <div className="example-grid">
                  ...
                  <article className="example-card">
                    ...
                    <p className="example-card__caption" data-lang="ko" hidden>활성 뷰는 단 한 줄의 밑줄로만 표시합니다. 나머지는 중립으로 두어 현재 섹션이 한눈에 들어오게 합니다.</p>
  ...
  "queued_at": "10:24:11Z"
                  ...
                  <article className="example-card example-card--wide">
                    ...
                    <div className="notice notice--warn">
                      ...
                      <p data-lang="ko" hidden>
                        최근 5분 동안 디스패치 큐에서 재시도가 세 번 발생했습니다. 일시적인 패턴으로 보이지만, 한 번 확인하는 것이 좋습니다.
                      </p>
                      <p data-lang="ja" hidden>
              ...
              <section className="section" id="faq">
                ...
                <div className="faq">
                  ...
                  <details className="faq-item">
                    ...
                    <p data-lang="ko" hidden>주 포인트는 틸 하나로 유지하세요. 톤다운된 브라스 보조 강조는 한 번 정도 괜찮지만, 밝은 색이 여러 개면 페이지가 컨셉 보드처럼 보입니다.</p>
                  ...
                  <details className="faq-item">
                    ...
                    <p data-lang="ko" hidden>글래스 효과, 과한 그라데이션, 두꺼운 그림자, 지나치게 많은 칩 색상입니다. 이 페이지는 극적이 아니라 기술적으로 보여야 합니다.</p>
              ...
              <section className="section" id="style-notes">
                ...
                <div className="notes-grid">
                  <article className="note-card">
                    ...
                    <p data-lang="ko" hidden>큰 헤드라인이 감정선을 만들고, 모노 라벨과 시각 정보는 2차적인 정밀 요소로 남아야 합니다.</p>
                    <p data-lang="ja" hidden>大きな見出しが感情を担当し、モノのラベルや時刻情報は二次的な精密要素として残します。</p>
                    <ul data-lang="en">
                  ...
                  <article className="note-card">
                    ...
                    <h3 data-lang="ko" hidden>컬럼 라인은 존재하되, 결코 주인공이 되면 안 됩니다.</h3>
                    ...
                    <p data-lang="ko" hidden>희미한 그리드는 페이지에 기술적인 자세를 줍니다. 정렬을 돕는 선이어야지 장식이 되어서는 안 됩니다.</p>
                  ...
                  <article className="note-card">
                    ...
                    <p className="note-card__eyebrow" data-lang="ko" hidden>액센트 제어</p>
                    ...
                    <h3 data-lang="ko" hidden>미네랄 틸을 주역으로 두고, 브라스는 한 번만 보조로 씁니다.</h3>
                    ...
                    <p data-lang="ko" hidden>미네랄 틸이 시그니처를 맡고, 톤다운된 브라스는 짧은 문장이나 보조 상태 하나만 강조합니다. 나머지는 중립을 유지합니다.</p>
                    ...
                    <ul data-lang="ko" hidden>
                      ...
                      <li>색은 무드보드가 아니라 위계를 설명해야 합니다.</li>
                    </ul>
                    <ul data-lang="ja" hidden>
              ...
              <footer className="footer section" id="footer">
                <div className="footer__grid">
                  <section className="footer__panel">
                    ...
                    <h3 data-lang="ko" hidden>이 스타일은 페이지가 홍보보다 먼저 운영형 신뢰를 보여줘야 할 때 사용합니다.</h3>
