...
const COPY = {
  ...
  hint: {
    ...
    ko: 'RUN을 눌러 부팅을 한 단계씩 — 그리고 CRT 색을 바꿔보세요',
    ja: 'RUNを押して一行ずつ起動 — それからCRT色を変えてみてください',
  },
  about: {
    en: [
    ...
    ko: [
      ...
      '· 크롬은 단단하고 인쇄된 듯해야 한다.',
      '· 화면만 살아 있다. 오직 화면만.',
      '· 데스크톱은 빛나지 않는다. CRT 밖에서는 스캔라인이 돌지 않는다.',
      '',
    ...
    ja: [
      ...
      '・クロームは硬く、印刷されたように。',
      '・画面だけが生きている。画面だけ。',
      '・デスクトップは光らない。CRTの外でスキャンラインは回らない。',
      '',
      'OKで閉じる — フロッピーは回り続けます。',
    ],
  },
  ...
  endNote: {
    ...
    ko: '(스크립트 끝 — Reset으로 플로피를 되감기)',
    ja: '(スクリプト終了 — Resetでフロッピーを巻き戻す)',
  },
  clock: '09:42 AM',
