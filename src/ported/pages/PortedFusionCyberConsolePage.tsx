...
const COPY = {
  ...
  status: {
    en: [
      { dt: 'Runtime', dd: '04:12:33', hot: false },
      { dt: 'Accent', dd: 'magenta', hot: true },
      { dt: 'Drift', dd: '0.02 s', hot: false },
      { dt: 'Mode', dd: 'operator', hot: false },
    ],
    ko: [
      { dt: '런타임', dd: '04:12:33', hot: false },
      { dt: '액센트', dd: 'magenta', hot: true },
      { dt: '드리프트', dd: '0.02 s', hot: false },
      { dt: '모드', dd: 'operator', hot: false },
    ],
    ja: [
      { dt: 'ランタイム', dd: '04:12:33', hot: false },
      { dt: 'アクセント', dd: 'magenta', hot: true },
      { dt: 'ドリフト', dd: '0.02 s', hot: false },
      { dt: 'モード', dd: 'operator', hot: false },
    ],
  },
