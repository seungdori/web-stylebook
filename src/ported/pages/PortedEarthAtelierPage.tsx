        ...
        <main className="page">
          ...
          <section className="atelier">
            ...
            <div className="hero">
              ...
              <p className="hero__lead" data-lang="ko" hidden>따뜻한 뉴트럴, 저명도 텍스트, 절제된 유기적 형태로 완성하는 감성적이면서도 읽기 쉬운 인터페이스. 모든 디테일이 자연에서 비롯됩니다.</p>
              <p className="hero__lead" data-lang="ja" hidden>温かなニュートラル、低明度テキスト、節制された有機的形態で仕上げる感性的でありながら読みやすいインターフェース。すべてのディテールは自然から。</p>
            ...
            <div className="intro">
              <div className="intro__text">
                ...
                <p data-lang="ko" hidden>자연 소재의 불완전함에 뿌리를 둔 디자인 언어. 디지털 인터페이스가 차갑게 느껴지기 쉬운 곳에, 신중하게 선택한 어스 톤과 요소 사이의 넉넉한 여백으로 따뜻함을 부여합니다.</p>
                <p data-lang="ja" hidden>自然素材の不完全さに根ざしたデザイン言語。デジタルインターフェースが無機質に感じられがちな場面で、慎重に選んだアースカラーと要素間のゆとりある余白で温もりを届けます。</p>
              </div>
              ...
              <div className="principles__grid">
                <ul className="principles__list" data-lang="ko" hidden>
                  <li className="principles__item">
                    ...
                    <div className="principles__desc">강한 네온 대신 토양과 식물 계열 색상을 사용합니다. 모든 색이 자연에서 가져옵니다.</div>
                  </li>
                  <li className="principles__item">
                    <span className="principles__num">II</span>
                    <span className="principles__kicker">여백</span>
                    <div className="principles__title">넉넉한 여백</div>
                    <div className="principles__desc">요소 사이의 여유로운 공간이 안정감을 줍니다. 공간은 디자인 소재입니다.</div>
                  </li>
                  <li className="principles__item">
                    <span className="principles__num">III</span>
              ...
              <div className="principles__grid">
                <ul className="principles__list" data-lang="ja" hidden>
                  <li className="principles__item">
                    ...
                    <div className="principles__desc">強いネオンの代わりに土壌・植物系カラーを使用。すべての色は自然から。</div>
                  </li>
                  <li className="principles__item">
                    <span className="principles__num">II</span>
