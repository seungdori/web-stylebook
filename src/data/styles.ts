...
export const styleCatalog: StyleData[] = [
  ...
  detail(
    ...
    'Strict Console',
    ['light', 'tech', 'minimal'],
    ['#f4f1ea', '#ffffff', '#e6332d', '#0a0a0a'],
    '#e6332d',
    t(
      'A B2B SaaS landing where Swiss 12-column rigour holds a calm operational dashboard.',
      '스위스의 12열 엄격함이 차분한 운영 대시보드를 잡아주는 B2B SaaS 랜딩.',
      'スイスの12カラムの厳格さが静かな運用ダッシュボードを支えるB2B SaaSランディング。',
    ),
    t(
      'A trust-first product page built from grid, tabular numerics, and a single red marker.',
      '그리드, tabular 숫자, 단 하나의 빨간 마커로 만든 신뢰 우선 제품 페이지.',
      'グリッド、tabular数値、ただ一つの赤いマーカーで作る信頼第一の製品ページ。',
    ),
    prompt('Inter at 1-2 weights paired with JetBrains Mono for every numeric', 'Strict 12-col grid containing a real ops panel, pricing matrix, and customer logo bar', 'Purposeful state changes only — no decorative motion', ['B2B SaaS landings', 'design system marketing', 'fintech and devtool products', 'internal admin marketing'], ['Use red exactly once per section', 'Never use the red as a button — keep it as a marker'], ['lifestyle commerce', 'wellness brands', 'children products', 'consumer entertainment']),
    visual('grid-first sans with mono data', 'paper-grey panels with hairlines', 'strict left-aligned rhythm'),
  ...
  detail(
    ...
    ['#fff4ee', '#080604', '#cf493c', '#2f8b8e', '#6d98ca'],
    '#cf493c',
    t(
