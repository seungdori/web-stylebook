...
An open-source web stylebook for AI-assisted frontend work: **34 style templates**, **9 fusion combinations**, style comparison, prompt generation, palette testing, and a motion lab.
...
- `src/ported/pages/*.tsx` contains the React source of truth for all 34 style pages and 9 fusion pages.
